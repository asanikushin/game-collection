...
def test_batch_csv():
    ...
    value = BatchElement.from_csv_row('307679,Billionaire,1973,Economic,,4,Auction/Bidding,2', index)
    assert value == BatchElement('Billionaire', 'Economic', 2, 4)

    value = BatchElement.from_csv_row('145,Metropolis,1984,City Building | Negotiation,,5,,2', index)
