...
_IMPORTREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="loaded",
            full_name="ImportRequest.loaded",
            index=1,
            number=2,
            type=8,
            cpp_type=7,
...
ImportResponse = _reflection.GeneratedProtocolMessageType(
    "ImportResponse",
    (_message.Message,),
    {
