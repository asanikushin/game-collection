...
rating.add_url_rule("/<int:game_id>", "get_game_rating", get_game_rating, methods=["GET"])
rating.add_url_rule("/", "add_scores", add_score, methods=['POST'])

rating.add_url_rule("/<int:game_id>", "patch_score", patch_score, methods=['PUT', 'PATCH'])
...
rating.add_url_rule("/user/<int:user_id>", "get_ratings", get_user_scores, methods=["GET"])
